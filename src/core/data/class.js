...
export const classListInit = function (activeName, pageNum) {
  ...
  if (activeName == "student") {
    apiurl =
      "/classform/list?isstudent=" + window.liveBroadcastService.userId + "&pageNum=" + pageNum;
  }
  if (activeName == "teacher") {
    apiurl =
      "/classform/list?createUser=" + window.liveBroadcastService.userId + "&pageNum=" + pageNum;
  }
