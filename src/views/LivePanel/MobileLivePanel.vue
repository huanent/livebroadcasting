...
import CameraPanel from "./components/mobile/CameraPanel";
import SettingPanel from "./components/mobile/SettingPanel";
import BoardToolbar from "./components/mobile/BoardToolbar";
...
import LiveControl from "./components/mobile/LiveControl";
import HroizontalTipCover from "./components/mobile/HorizontalTipCover";
export default {
  name: "MobileLivePanel",
  data: function() {
    return {
      ready: false,
      timer: null,
